...
void main() {
  ...
  group('city', () {
    ...
    test('literalFromJson should return a a city with id, name, description, cityMetrics, empty routes and countryId', () {
    ...
    test('fromJson should return a a city with id, name, description, cityMetrics, routes and countryId', () {
    ...
    test('fetchRoutesForGivenCity(id) should return all routes where the target city has passed id', () {
      ...
      RouteEntity routeToABUS = RouteEntity('1', 4.0, 3.2, 16.0, TransportType.BUS, cityA);
      RouteEntity routeToAFLIGHT = RouteEntity('2', 4.5, 5, 30.0, TransportType.FLIGHT, cityA);
      RouteEntity route = RouteEntity('3', 8, 4.3, 32.0, TransportType.BUS, cityB);
    ...
    test('fetchRoutesForGivenCity(id) should return empty Set when there are no routes where the target city has has passed id', () {
      ...
      RouteEntity route = RouteEntity('1', 4.0, 3.2, 32.0, TransportType.BUS, cityB);
